...
public class CaseCreationTest extends BaseTest
{
	...
	public void casestest(String TC_ID, String Projectname,String projectmodule, String ProductTypeCaseValue, String Account_Name, String Assigned_To, String CaseAnalysisValue, String Status ) throws Exception 
	{
		...
		cp.summarypage();
		Thread.sleep(10000);
		cp.casespage(Projectname,projectmodule,ProductTypeCaseValue,Account_Name,Assigned_To, CaseAnalysisValue);
		Thread.sleep(10000);
